...
class MyCourseWidgetUI extends StatefulWidget {
  const MyCourseWidgetUI({super.key});

  @override
  State<MyCourseWidgetUI> createState() => _MyCourseWidgetUIState();
}

class _MyCourseWidgetUIState extends State<MyCourseWidgetUI> {
  @override
