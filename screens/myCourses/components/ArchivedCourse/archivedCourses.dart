...
class ArchivedCourse extends StatefulWidget {
  const ArchivedCourse({super.key});

  @override
  State<ArchivedCourse> createState() => _ArchivedCourseState();
}

class _ArchivedCourseState extends State<ArchivedCourse> {
  @override
